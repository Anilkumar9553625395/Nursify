        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-28 grid lg:grid-cols-2 gap-16 items-center">
          <div className="z-10">
            ...
            <div className="mt-10 flex flex-wrap gap-4 items-center">
              ...
              <Link href="/signup" className="bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 flex items-center gap-3 border border-white/20 hover:border-emerald-400/40">
                <Heart size={20} />
                Register as Patient
              </Link>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            <Link href="/signup" className="bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white px-10 py-4 rounded-xl font-bold text-lg transition-all duration-300 flex items-center gap-3 border border-white/20 hover:border-emerald-400/40">
